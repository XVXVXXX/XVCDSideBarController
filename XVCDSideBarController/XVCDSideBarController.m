...
static  XVCDSideBarController *sharedInstance;
@implementation XVCDSideBarController
...
+(XVCDSideBarController *)sharedInstanceWithImages:(NSArray*)images{
    ...
    dispatch_once(&onceToken, ^{
        sharedInstance = [[XVCDSideBarController alloc]initWithImages:images];
    });
...
- (XVCDSideBarController*)initWithImages:(NSArray*)images
{
